...
import { faArrowRightArrowLeft, faCircleCheck, faCircleExclamation, faCircleXmark } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <div className={cx('hints')} >
                            ...
                            >
                                <div>
                                    ...
                                    <FontAwesomeIcon icon={faArrowRightArrowLeft} className={cx('icon')}/> 
                                    <span dangerouslySetInnerHTML={{ __html:  answer.suggest.question}}></span>
                                </div>
                                <div>
                                    <b>Answer Correct: </b>
                                ...
                                <div>
                                    <b>Quote: </b> 
                                    <span dangerouslySetInnerHTML={{ __html:  answer.suggest.correct}}></span>
                                    <FontAwesomeIcon icon={faArrowRightArrowLeft} className={cx('icon')}/> 
                                    <span dangerouslySetInnerHTML={{ __html:  answer.suggest.translate}}></span>
                                </div>
                            </div>
                        </div>
                    </div>
